...
exports.run = async (client, message, args) => {
    ...
    let embed = new discord.MessageEmbed()
        ...
        .addField('🗺 Region:', client.tools.CapitaliseFirstLetter(guild.region), true)
        .addField('🗓 Created:', client.tools.CapitaliseFirstLetter(moment(message.guild.createdAt).fromNow()) + ' (' + moment(message.guild.createdAt).format('MMMM Do YYYY') + ')', false)
